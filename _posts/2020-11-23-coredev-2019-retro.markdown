...
---
In January, John Newbery sent out a Bitcoin Core contributor survey in preparation for the March [Coredev](https://coredev.tech/) meeting, which was later canceled due to COVID-19. Given that the year is coming to a close, I thought it might be good timing to retrospect on those responses even though the responses are now somewhat outdated to reflect on the goals for 2020 and prepare for another survey in early 2021.

For those that prefer video to the written word, I've prepared a 10-minute presentation. (The contents are roughly the same.)

<iframe width="560" height="315" src="https://www.youtube.com/embed/QGUv7nb5Wis?rel=0" frameborder="0" allow="clipboard-write; encrypted-media; modestbranding;" allowfullscreen></iframe>

The survey consisted of 10 questions, which included:
...
31 respondents filled out the survey.

I've pinned a word cloud of the responses as the banner at the top.
...
Project highlights from 2019 included:
  ...
  - Build system (guix)
  - Assumeutxo
  - Building on Windows has become a mature part of the CI Package relay progress
  - Misc P2P
...
Review was a central theme found in nearly all of the responses. The word "review" 80 times among the 31 answers. Below are some quotes bucketed (by me) into themes.
...
Thank you to John Newbery for sending out this survey in January. Surveys of this sort are usually more valuable when done consistently over time and contrasted, so I look forward to sending out a similar survey in 2021 and presenting the results.
